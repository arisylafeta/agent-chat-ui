    ...
    <div className="flex flex-row items-center justify-center gap-0">
      <Button
        ...
        className={cn(
          ...
          showingState ? "text-black-soft" : "bg-white-soft",
        )}
        size="sm"
      ...
      <Button
        ...
        className={cn(
          ...
          showingDescription ? "text-black-soft" : "bg-white-soft",
        )}
        size="sm"
  ...
  return (
    <div className="flex min-h-full w-full flex-col gap-9">
        ...
        <div className="flex flex-row items-center justify-start gap-2">
          {apiUrl && (
            <Button
              size="sm"
              variant="outline"
              className="flex items-center gap-1 bg-white-soft"
      ...
      <div className="flex w-full flex-row items-center justify-start gap-2">
        <Button
          variant="outline"
          className="border-gray-500 bg-white-soft font-normal text-gray-800"
