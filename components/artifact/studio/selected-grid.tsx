...
export function SelectedGrid() {
  ...
  return (
    <div className="grid auto-rows-max grid-cols-2 gap-4 min-[60rem]:grid-cols-3 min-[75rem]:grid-cols-1 min-[85rem]:grid-cols-2 min-[95rem]:grid-cols-3 min-[115rem]:grid-cols-4 min-[135rem]:grid-cols-5">
